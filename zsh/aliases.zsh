...
alias l='le -aG -F'
alias le='eza --icons --group-directories-first --color=auto --extended -ai --group-directories-last'
...
alias -g -- --help="--help ... 2>&1 | bat --language=help --style=plain"
#alias -g -- -h="-h 2>&1 | bat --language=help --style=plain --color=always"
