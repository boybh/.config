...
fpath=("${HOME}/.config/.zim/modules/git/functions" "${HOME}/.config/.zim/modules/utility/functions" "${HOME}/.config/.zim/modules/duration-info/functions" "${HOME}/.config/.zim/modules/git-info/functions" "${HOME}/.config/.zim/modules/zsh-completions/src" ${fpath})
